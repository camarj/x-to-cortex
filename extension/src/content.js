...
// Sync masivo descartado en favor del botón individual por tweet.
// Razón: scraping del DOM en /i/bookmarks no captura hilos completos ni
// posts truncados con "Show more". Para resolverlo bien haría falta usar
// la API GraphQL interna de X (frágil, riesgo de bloqueo de cuenta).
// El botón individual desde el permalink de un tweet sí captura el hilo completo.
